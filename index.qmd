...
* One insight is that creativity isn't just black-and-white thinking. It's not as simple as being either creative or not. Instead, it's about being able to switch between different ways of thinking, depending on the situation.

* Sometimes, You might need to explore many possibilities (`divergent`), or approach a problem from a new angle (`lateral`). Eventually, you'll need to bring your ideas together (`converge`) to execute.

* My main challenge isn't coming up with creative ideas, but turning those ideas into real innovations. This is due to risk-averse nature and laid-back attitude.
...
* All the images used in this slides are generated by AI image generation tools such as [Google Gemini](https://gemini.google.com/app). 
